...
1. Review the English page in `site/index.html`, the Traditional Chinese page in `site/zh-TW/index.html`, and the workflow.
2. Merge the `docs/github-pages-user-guide` branch into `main`. The branch itself does not publish the site because the workflow only deploys pushes to `main`.
